...
\visible<2->{From this, we could obtain the \textbf{maximum likelihood}, taking the derivatives of the log probability to zero, according to the terms $\beta$ and $\mathbf{w}$, our model parameters. We'll obtain
\begin{equation*}
