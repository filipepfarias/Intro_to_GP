...
\begin{frame}{\insertsubsection}
    ...
    \begin{subfigure}[t]{0.4\textwidth}
        \centering
        \includegraphics[height=1.4in]{"Figure1.29a".eps}
    \end{subfigure}%
    \begin{subfigure}[t]{0.4\textwidth}
        \centering
        \includegraphics[height=1.4in]{"Figure1.29b".eps}
		\end{subfigure}
		\\
		\begin{subfigure}[t]{0.4\textwidth}
			\centering
			\includegraphics[height=1.4in]{"Figure1.29c".eps}
		\end{subfigure}%
		\begin{subfigure}[t]{0.4\textwidth}
				\centering
				\includegraphics[height=1.4in]{"Figure1.29d".eps}
		\end{subfigure}
	\end{figure}
...
\vspace{1em}
Let's say we have the probabilities of some idea we desire to update it in the light of some new evidence. This could be done with \textbf{Bayes' Theorem}, to convert a \textit{prior} probability in a \textit{posterior} probability and put some uncertainty in the parameters too. \\
\end{frame}
