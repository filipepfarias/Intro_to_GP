...
\visible<2->{
	\begin{align}
		y_i(x_i,\mathbf{w}) &= w_0x^0_i + w_1x_i + w_2x^2_i  + ... + w_Mx^M_i \nonumber \\
					& = \sum^M_{j=0} w_j x^j_i
	\end{align}
}
\visible<3->{
...
\begin{align}
	0 =& \frac{\partial}{\partial \mathbf{w}} E(\mathbf{w})\nonumber \\
	0 =& \sum_{n=1}^N \frac{\partial}{\partial \mathbf{w}} y_n(x_n,\mathbf{w}) \left\{  y_n(x_n,\mathbf{w}) -  t_n \right\}
\end{align}
...
\frac{\partial}{\partial w_1} y_(x,\mathbf{w}) \left\{  y(x,\mathbf{w}) -  t_n \right\} \\
