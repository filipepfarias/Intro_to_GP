...
\begin{equation}
\begin{aligned} p(\mathbf{f}_{*} | \mathbf{x}, \mathbf{y},\mathbf {x_{*}}) &= \mathcal{N}\left(\overline{\mathbf{f}}_{*}, \mathrm{cov}\left(\mathbf{f}_{*}\right)\right), \text { where } \\ \overline{\mathbf{f}}_{*} & \triangleq \mathbb{E}\left\{ \mathbf{f}_{*} | \mathbf{x}, \mathbf{y}, \mathbf{x_{*}}\right\}=\mathbf{K}\left(\mathbf{x_{*}}, \mathbf{x}\right)\left(\mathbf{K}(\mathbf{x}, \mathbf{x})+\beta^{-1} \mathbf{I}\right)^{-1} \mathbf{y} \\ \mathrm{cov}\left(\mathbf{f}_{*}\right) &=\mathbf{K}\left(\mathbf{x_{*}}, \mathbf{x_{*}}\right)-\mathbf{K}\left(\mathbf{x_{*}}, \mathbf{x}\right)\left(\mathbf{K}(\mathbf{x}, \mathbf{x})+\beta^{-1} \mathbf{I}\right)^{-1} \mathbf{K}\left(\mathbf{x}, \mathbf{x_{*}}\right) \end{aligned}
\end{equation}
