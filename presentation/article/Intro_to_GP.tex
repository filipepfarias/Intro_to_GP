...
What was done was just \textit{conditioning} the prediction to $\mathbf{w}$, i.e. to found the predictive distribution considering the probabilities of $\mathbf{w}$ and the likelihood function. The marginalization for the Gaussian distributions are in the
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
