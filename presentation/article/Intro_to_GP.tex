...
\begin{equation}
   p(y | \mathbf{y},\mathbf{x},x, \alpha, \beta)=\int p(y | \mathbf{w},\mathbf{x},x, \beta) p(\mathbf{w} | \mathbf{y},\mathbf{x},x, \alpha, \beta) \mathrm{d} \mathbf{w}
\end{equation}

what is called \textit{predictive distribution}
