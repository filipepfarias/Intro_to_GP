...
\begin{figure}  
    \begin{center}
        \begin{tikzpicture}
            ...
            \node[obs, semithick, below=of fi, fill=red!20!blue!30!white, semithick, draw=red]              (xi) {$\mathbf{x}_i$};%
            \node[obs, semithick, below=of f*, fill=red!20!blue!30!white, semithick, draw=red]              (x*) {$\mathbf{x}_*$};%
            % \node[obs, semithick, above=of f0s ,fill=red!20!blue!30!white, semithick, draw=red]              (y0s) {};%

            \node[latent, semithick, draw=red, above=.5 of f*, xshift= 1cm] (th) {$\theta$};
