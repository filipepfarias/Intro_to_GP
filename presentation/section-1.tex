...
\textit{A \textbf{random experiment} is specified by \textbf{\textcolor{red}{starting}} an experimental procedure and a set of one or more measurements or observations.}
\end{block}
