...
\begin{frame}{\insertsection}
    \framesubtitle{Linear Prior} 

	\begin{equation*}
		\phi(x) = \left( 1 \quad x \quad x.^2 \quad x.^3 \quad x.^4 \quad x.^5 \right)^\top
	\end{equation*}
...
\begin{frame}{\insertsection}
	\framesubtitle{Linear Posterior} 
	
	\begin{equation*}
		\phi(x) = \left( 1 \quad x \right)^\top
	\end{equation*}
...
\begin{frame}{\insertsection}
    \framesubtitle{Polynomial Prior} 
...
\begin{frame}{\insertsection}
    \framesubtitle{Polynomial Posterior} 
...
\begin{frame}{\insertsection}
	\framesubtitle{Absolute Prior} 
	
	\begin{equation*}
		\phi(x)=(|x-8|+8 \quad|x-7|+7 \quad|x-6|+6 \quad \ldots)^{\top}
	\end{equation*}
...
\begin{frame}{\insertsection}
    \framesubtitle{Absolute Posterior} 
...
\begin{frame}{\insertsection}
	\framesubtitle{Bell Curve Prior}
	
	\begin{equation*}
	\phi(x)=\left(e^{-\frac{1}{2}(x-8)^{2}} e^{-\frac{1}{2}(x-7)^{2}} \quad e^{-\frac{1}{2}(x-6)^{2}}\ldots \right)^{\top}
	\end{equation*}
...
\begin{frame}{\insertsection}
    \framesubtitle{Bell Curve Posterior}
...
\begin{frame}{\insertsection}
    \framesubtitle{Fourier Prior} 

	\begin{equation*}
		\phi(x)=(\cos (x) \cos (2 x) \cos (3 x) \quad \ldots \quad \sin (x) \quad \sin (2 x) \quad \ldots)^{\top}
	\end{equation*}
...
\begin{frame}{\insertsection}
    \framesubtitle{Fourier Posterior} 
...
\begin{frame}{\insertsection}
	\framesubtitle{Legendre Prior} 
	
	\begin{equation*}
		\phi(x)=\left(b^{0} P_{0}(x), b^{1} P_{1}(x), \ldots, b^{13} P_{13}(x)\right)^{\top} \quad P_{n}(x)=\frac{1}{2^{n} n !} \frac{d^{n}}{d x^{n}}\left(x^{2}-1\right)^{n}
	\end{equation*}
...
\begin{frame}{\insertsection}
	\framesubtitle{Legendre Posterior} 
...
\begin{frame}{\insertsection}
	\framesubtitle{Step Prior} 
	
	\begin{equation*}
		\phi(x)=-1+2(\theta(x-8) \quad \theta(8-x) \quad \theta(x-7) \quad \theta(7-x) \quad \ldots)^{\top}
	\end{equation*}
...
\begin{frame}{\insertsection}
	\framesubtitle{Increasing Step Prior} 
...
\begin{frame}{\insertsection}
	\framesubtitle{Increasing Step Posterior} 
...
\begin{frame}{\insertsection}
	\framesubtitle{Bidimensional Bell Curve Prior}
	
	\begin{equation*}
	\phi(x)=\left(e^{-\frac{1}{2}(\mathbf{x}-(8,8))^{2}} e^{-\frac{1}{2}(\mathbf{x}-(8,7))^{2}} \quad \ldots e^{-\frac{1}{2}(\mathbf{x}-(7,8))^{2}}\ldots \right)^{\top}
	\end{equation*}
    ...
    \begin{center}
		...
		\resizebox{\linewidth}{!}{	
			\begin{animateinline}[autoplay,loop]{15}
				%  \includegraphics{./codes/baRegAnimPr/"baRegAnimPr_prior_frame_0"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_prior_frame_1"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_prior_frame_2"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_prior_frame_3"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_prior_frame_4"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_prior_frame_5"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_prior_frame_6"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_prior_frame_7"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_prior_frame_8"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_prior_frame_9"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_prior_frame_10"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_prior_frame_11"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_prior_frame_12"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_prior_frame_13"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_prior_frame_14"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_prior_frame_15"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_prior_frame_16"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_prior_frame_17"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_prior_frame_18"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_prior_frame_19"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_prior_frame_20"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_prior_frame_21"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_prior_frame_22"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_prior_frame_23"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_prior_frame_24"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_prior_frame_25"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_prior_frame_26"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_prior_frame_27"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_prior_frame_28"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_prior_frame_29"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_prior_frame_30"}
			 \end{animateinline}
			}
	\end{center}
...
\begin{frame}{\insertsection}
    \framesubtitle{Multidimensional Bell Curve Posterior}
    ...
    \begin{center}
		...
		\resizebox{\linewidth}{!}{	
			\begin{animateinline}[autoplay,loop]{15}
				%  \includegraphics{./codes/baRegAnimPr/"baRegAnimPr_prior_frame_0"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_post_frame_1"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_post_frame_2"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_post_frame_3"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_post_frame_4"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_post_frame_5"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_post_frame_6"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_post_frame_7"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_post_frame_8"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_post_frame_9"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_post_frame_10"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_post_frame_11"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_post_frame_12"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_post_frame_13"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_post_frame_14"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_post_frame_15"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_post_frame_16"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_post_frame_17"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_post_frame_18"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_post_frame_19"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_post_frame_20"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_post_frame_21"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_post_frame_22"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_post_frame_23"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_post_frame_24"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_post_frame_25"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_post_frame_26"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_post_frame_27"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_post_frame_28"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_post_frame_29"}\newframe
				 \includegraphics{./codes/baRegFunctionSpaceBellShape3D/"baRegFunctionSpaceBellShape3D_post_frame_30"}
			 \end{animateinline}
			}
	\end{center}
...
\begin{frame}{\insertsection}
    \framesubtitle{\textit{Kernelization} to infinitely many features} 

    \textcolor{UniGold}{\textbf{If we make the number of features goes to infinity?}}
    \begin{itemize}
        % \item We have 
		% \begin{equation*}
		% 	p(\mathbf{w}|\mathbf{t}) = \frac{p(\mathbf{t}|\mathbf{w}) p(\mathbf{w})}{p(\mathbf{t})} = \frac{p(\mathbf{t}|\mathbf{w}) p(\mathbf{w})}{\int p(\mathbf{t}|\mathbf{w}) p(\mathbf{w}) d\mathbf{w}}
		%  \end{equation*}
		% omitted $\mathbf{x}$ for brevity.
        \item Let's take the Bell Curve as example, or Gaussian function,
		\begin{equation*}
			\phi_{h}(\mathbf{x})=\exp \left[-\frac{\left(\mathbf{x}-\mathbf{c}_{h}\right)^{2}}{2 r^{2}}\right]
		\end{equation*}

		where $H$ is the number of features and $\mathbf{c}_{h}$ its centers positioning.
		\item Let's define too, the \textcolor{UniOrange}{\textbf{covariance matrix}} $\mathbf{C}$ with inputs
		\begin{equation*}
			C_{n n^{\prime}}=Q_{n n^{\prime}}+\delta_{n n^{\prime}} \sigma_{\nu}^{2}=\sigma_{w}^{2} \sum_{h} \phi_{h}\left(\mathbf{x}^{(n)}\right) \phi_{h}\left(\mathbf{x}^{\left(n^{\prime}\right)}\right)+\delta_{n n^{\prime}} \sigma_{\nu}^{2}
		\end{equation*}
		\only<1>{
		\item If we put the center of the curve at a point $x=h$ and take the limit $H \rightarrow \infty$, the sum over $h$ becomes an integral\footnote{To avoid the covariance divergence with H, we
		make $\sigma_{w}^{2}$ scale as $S/(\Delta H)$, where $\Delta H$ is the number of basis per unit length along the x-axis}
		\begin{equation*}
			\begin{aligned} Q_{n n^{\prime}} &=S \int_{h_{\min }}^{h_{\max }} \mathrm{d} h \phi_{h}\left(x^{(n)}\right) \phi_{h}\left(x^{\left(n^{\prime}\right)}\right) \\ &=S \int_{h_{\min }}^{h_{\max }} \mathrm{d} h \exp \left[-\frac{\left(x^{(n)}-h\right)^{2}}{2 r^{2}}\right] \exp \left[-\frac{\left(x^{\left(n^{\prime}\right)}-h\right)^{2}}{2 r^{2}}\right] \end{aligned}
		\end{equation*}
		}
		\only<2>{
		\item If we let the limits of integration be $\pm \infty$, we can solve this integral
		\begin{equation*}
			Q_{n n^{\prime}}=\sqrt{\pi r^{2}} S \exp \left[-\frac{\left(x^{\left(n^{\prime}\right)}-x^{(n)}\right)^{2}}{4 r^{2}}\right]
		\end{equation*}
		}
    \end{itemize}
\end{frame}
...
\begin{frame}{\insertsection}
    ...
    \begin{center}
		...
		\resizebox{\linewidth}{!}{	
			\begin{animateinline}[autoplay,loop]{15}
				%  \includegraphics{./codes/baRegAnimPr/"baRegAnimPr_prior_frame_0"}\newframe
				 \includegraphics{./codes/GPGauss1/"GPGauss1_prior_frame_1"}\newframe
				 \includegraphics{./codes/GPGauss1/"GPGauss1_prior_frame_2"}\newframe
				 \includegraphics{./codes/GPGauss1/"GPGauss1_prior_frame_3"}\newframe
				 \includegraphics{./codes/GPGauss1/"GPGauss1_prior_frame_4"}\newframe
				 \includegraphics{./codes/GPGauss1/"GPGauss1_prior_frame_5"}\newframe
				 \includegraphics{./codes/GPGauss1/"GPGauss1_prior_frame_6"}\newframe
				 \includegraphics{./codes/GPGauss1/"GPGauss1_prior_frame_7"}\newframe
				 \includegraphics{./codes/GPGauss1/"GPGauss1_prior_frame_8"}\newframe
				 \includegraphics{./codes/GPGauss1/"GPGauss1_prior_frame_9"}\newframe
				 \includegraphics{./codes/GPGauss1/"GPGauss1_prior_frame_10"}\newframe
				 \includegraphics{./codes/GPGauss1/"GPGauss1_prior_frame_11"}\newframe
				 \includegraphics{./codes/GPGauss1/"GPGauss1_prior_frame_12"}\newframe
				 \includegraphics{./codes/GPGauss1/"GPGauss1_prior_frame_13"}\newframe
				 \includegraphics{./codes/GPGauss1/"GPGauss1_prior_frame_14"}\newframe
				 \includegraphics{./codes/GPGauss1/"GPGauss1_prior_frame_15"}\newframe
				 \includegraphics{./codes/GPGauss1/"GPGauss1_prior_frame_16"}\newframe
				 \includegraphics{./codes/GPGauss1/"GPGauss1_prior_frame_17"}\newframe
				 \includegraphics{./codes/GPGauss1/"GPGauss1_prior_frame_18"}\newframe
				 \includegraphics{./codes/GPGauss1/"GPGauss1_prior_frame_19"}\newframe
				 \includegraphics{./codes/GPGauss1/"GPGauss1_prior_frame_20"}\newframe
				 \includegraphics{./codes/GPGauss1/"GPGauss1_prior_frame_21"}\newframe
				 \includegraphics{./codes/GPGauss1/"GPGauss1_prior_frame_22"}\newframe
				 \includegraphics{./codes/GPGauss1/"GPGauss1_prior_frame_23"}\newframe
				 \includegraphics{./codes/GPGauss1/"GPGauss1_prior_frame_24"}\newframe
				 \includegraphics{./codes/GPGauss1/"GPGauss1_prior_frame_25"}\newframe
				 \includegraphics{./codes/GPGauss1/"GPGauss1_prior_frame_26"}\newframe
				 \includegraphics{./codes/GPGauss1/"GPGauss1_prior_frame_27"}\newframe
				 \includegraphics{./codes/GPGauss1/"GPGauss1_prior_frame_28"}\newframe
				 \includegraphics{./codes/GPGauss1/"GPGauss1_prior_frame_29"}\newframe
				 \includegraphics{./codes/GPGauss1/"GPGauss1_prior_frame_30"}
			 \end{animateinline}
			}
	\end{center}
...
\begin{frame}{\insertsection}
    ...
    \begin{center}
		...
		\resizebox{\linewidth}{!}{	
			\begin{animateinline}[autoplay,loop]{15}
				%  \includegraphics{./codes/baRegAnimPr/"baRegAnimPr_prior_frame_0"}\newframe
				 \includegraphics{./codes/GPGauss2/"GPGauss2_prior_frame_1"}\newframe
				 \includegraphics{./codes/GPGauss2/"GPGauss2_prior_frame_2"}\newframe
				 \includegraphics{./codes/GPGauss2/"GPGauss2_prior_frame_3"}\newframe
				 \includegraphics{./codes/GPGauss2/"GPGauss2_prior_frame_4"}\newframe
				 \includegraphics{./codes/GPGauss2/"GPGauss2_prior_frame_5"}\newframe
				 \includegraphics{./codes/GPGauss2/"GPGauss2_prior_frame_6"}\newframe
				 \includegraphics{./codes/GPGauss2/"GPGauss2_prior_frame_7"}\newframe
				 \includegraphics{./codes/GPGauss2/"GPGauss2_prior_frame_8"}\newframe
				 \includegraphics{./codes/GPGauss2/"GPGauss2_prior_frame_9"}\newframe
				 \includegraphics{./codes/GPGauss2/"GPGauss2_prior_frame_10"}\newframe
				 \includegraphics{./codes/GPGauss2/"GPGauss2_prior_frame_11"}\newframe
				 \includegraphics{./codes/GPGauss2/"GPGauss2_prior_frame_12"}\newframe
				 \includegraphics{./codes/GPGauss2/"GPGauss2_prior_frame_13"}\newframe
				 \includegraphics{./codes/GPGauss2/"GPGauss2_prior_frame_14"}\newframe
				 \includegraphics{./codes/GPGauss2/"GPGauss2_prior_frame_15"}\newframe
				 \includegraphics{./codes/GPGauss2/"GPGauss2_prior_frame_16"}\newframe
				 \includegraphics{./codes/GPGauss2/"GPGauss2_prior_frame_17"}\newframe
				 \includegraphics{./codes/GPGauss2/"GPGauss2_prior_frame_18"}\newframe
				 \includegraphics{./codes/GPGauss2/"GPGauss2_prior_frame_19"}\newframe
				 \includegraphics{./codes/GPGauss2/"GPGauss2_prior_frame_20"}\newframe
				 \includegraphics{./codes/GPGauss2/"GPGauss2_prior_frame_21"}\newframe
				 \includegraphics{./codes/GPGauss2/"GPGauss2_prior_frame_22"}\newframe
				 \includegraphics{./codes/GPGauss2/"GPGauss2_prior_frame_23"}\newframe
				 \includegraphics{./codes/GPGauss2/"GPGauss2_prior_frame_24"}\newframe
				 \includegraphics{./codes/GPGauss2/"GPGauss2_prior_frame_25"}\newframe
				 \includegraphics{./codes/GPGauss2/"GPGauss2_prior_frame_26"}\newframe
				 \includegraphics{./codes/GPGauss2/"GPGauss2_prior_frame_27"}\newframe
				 \includegraphics{./codes/GPGauss2/"GPGauss2_prior_frame_28"}\newframe
				 \includegraphics{./codes/GPGauss2/"GPGauss2_prior_frame_29"}\newframe
				 \includegraphics{./codes/GPGauss2/"GPGauss2_prior_frame_30"}
			 \end{animateinline}
			}
	\end{center}
...
\begin{frame}{\insertsection}
    \framesubtitle{Gaussian Process - Prior}
    ...
    \begin{center}
		...
		\resizebox{\linewidth}{!}{	
			\begin{animateinline}[autoplay,loop]{15}
				%  \includegraphics{./codes/baRegAnimPr/"baRegAnimPr_prior_frame_0"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_prior_frame_1"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_prior_frame_2"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_prior_frame_3"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_prior_frame_4"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_prior_frame_5"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_prior_frame_6"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_prior_frame_7"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_prior_frame_8"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_prior_frame_9"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_prior_frame_10"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_prior_frame_11"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_prior_frame_12"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_prior_frame_13"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_prior_frame_14"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_prior_frame_15"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_prior_frame_16"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_prior_frame_17"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_prior_frame_18"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_prior_frame_19"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_prior_frame_20"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_prior_frame_21"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_prior_frame_22"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_prior_frame_23"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_prior_frame_24"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_prior_frame_25"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_prior_frame_26"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_prior_frame_27"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_prior_frame_28"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_prior_frame_29"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_prior_frame_30"}
			 \end{animateinline}
			}
	\end{center}
...
\begin{frame}{\insertsection}
    ...
    \begin{center}
		...
		\resizebox{\linewidth}{!}{	
			\begin{animateinline}[autoplay,loop]{15}
				%  \includegraphics{./codes/baRegAnimPr/"baRegAnimPr_prior_frame_0"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_post_frame_1"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_post_frame_2"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_post_frame_3"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_post_frame_4"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_post_frame_5"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_post_frame_6"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_post_frame_7"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_post_frame_8"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_post_frame_9"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_post_frame_10"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_post_frame_11"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_post_frame_12"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_post_frame_13"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_post_frame_14"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_post_frame_15"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_post_frame_16"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_post_frame_17"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_post_frame_18"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_post_frame_19"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_post_frame_20"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_post_frame_21"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_post_frame_22"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_post_frame_23"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_post_frame_24"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_post_frame_25"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_post_frame_26"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_post_frame_27"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_post_frame_28"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_post_frame_29"}\newframe
				 \includegraphics{./codes/GPGaussPrior/"GPGaussPrior_post_frame_30"}
			 \end{animateinline}
			}
	\end{center}
