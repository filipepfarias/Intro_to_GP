...
\documentclass[usenames,dvipsnames,8pt,aspectratio=43]{beamer}
...
\graphicspath{{codes/}{graphics/}{graphics/prml/}{graphics/prml-pdf/}{implementations/}}
...
%\include{bayesian-linear-regression}
