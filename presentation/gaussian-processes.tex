...
\begin{frame}{\insertsubsection}
    ...
    \begin{itemize}
        ...
        \item Our model is given by $\mathbf{y}(\mathbf{x}) = \boldsymbol{\Phi}^T \mathbf{w}$, where $\boldsymbol{\Phi}$ is the \textcolor{UniOrange}{\textbf{design matrix}}, and this caracterize our model as \textcolor{UniOrange}{\textbf{linear in parameters}}.
